            ...
            <div class="container-fluid">
                <div class="">
                    <div class="card card-primary">
                        ...
                        @endif
                        <form role="form" method="POST" action="{{ route('testimony.store') }}"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"
                                                placeholder="Entrez le nom du témoin" name="nom" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control"
                                                placeholder="Entrez la note d'étoile" name="note" required>
                                        </div>
                                    </div>
                                </div>
