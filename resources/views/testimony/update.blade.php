            ...
            <div class="container-fluid">
                <div class="">
                    <div class="card card-primary">
                        ...
                        @endif
                        <form role="form" method="POST" action="{{ route('testimony.update', $testimonies->id) }}"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"
                                                placeholder="Entrez le nom du témoin" name="nom"
                                                value="{{ old('nom') ?? $testimonies->nom }}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input"
                                                        ...
                                                        value="{{ old('image') ?? $testimonies->image }}">
                                                    <label class="custom-file-label"
                                                        for="exampleInputFile">{{ old('image') ?? $testimonies->image }}</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control"
                                                placeholder="Entrez la note d'étoile" name="note"
                                                value="{{ old('note') ?? $testimonies->note }}" required>
                                        </div>
                                    </div>
                                </div>
