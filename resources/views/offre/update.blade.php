            ...
            <div class="container-fluid">
                <div class="">
                    <div class="card card-primary">
                        ...
                        @endif
                        <form role="form" method="POST" action="{{ route('offre.update', $offres->id) }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Entrez la catégorie"
                                                name="categorie" value="{{ old('categorie') ?? $offres->categorie }}"
                                                required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"
                                                placeholder="Entrez le nom de l'entrprise" name="entreprise"
                                                value="{{ old('entreprise') ?? $offres->entreprise }}" required>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Entrez le titre"
                                                name="titre" value="{{ old('titre') ?? $offres->titre }}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"
                                                ...
                                                value="{{ old('description_courte') ?? $offres->description_courte }}"
                                                required>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Entrez le lien"
                                                name="lien" value="{{ old('lien') ?? $offres->lien }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Entrez le Site"
                                                name="site" value="{{ old('site') ?? $offres->site }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Entrez le lieu"
                                                name="lieu" value="{{ old('lieu') ?? $offres->lieu }}">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Facebook"
                                                name="facebook" value="{{ old('facebook') ?? $offres->facebook }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Twitter"
                                                name="twitter" value="{{ old('twitter') ?? $offres->twitter }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"
                                                ...
                                                value="{{ old('linkedin') ?? $offres->linkedin }}">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" placeholder=""
                                                name="date_lim" value="{{ old('date_lim') ?? $offres->date_lim }}">
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" id="exampleCheck1"
                                                name="valide" data-key="{{ $offres->id }}" value="1"
                                                @if ($offres->valide == 1) checked @endif
                                                @if ($offres->valide == 0) unchecked @endif>
