                                    ...
                                    <tbody>
                                        @foreach ($horaires as $horaire)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a href="{{ route('horaire.edit', $horaire->identifiant) }}"
                                                    ...
                                                    <button class="btn btn-default"
                                                        onclick="deleteData({{ $horaire->identifiant }})"
                                                        data-id="{{ $horaire->identifiant }}"
                                                        data-target="#default{{ $horaire->identifiant }}">
                                                        <i class="fas fa-trash"></i> Supprimer
                                                    </button>
