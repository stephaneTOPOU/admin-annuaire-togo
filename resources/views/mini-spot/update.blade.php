            ...
            <div class="container-fluid">
                <div class="">
                    <div class="card card-primary">
                        ...
                        @endif
                        <form role="form" method="POST" action="{{ route('mini-spot.update', $minspots->id) }}"
                                            ...
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input"
                                                        ...
                                                        value="{{ old('video') ?? $minspots->video }}">
                                                    <label class="custom-file-label"
                                                        for="exampleInputFile">{{ old('video') ?? $minspots->video }}</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input"
                                                        ...
                                                        value="{{ old('image') ?? $minspots->image }}">
                                                    <label class="custom-file-label"
                                                        for="exampleInputFile">{{ old('image') ?? $minspots->image }}</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
