                                    ...
                                    <tbody>
                                        @foreach ($annonces as $annonce)
                                            <tr>
                                                <td>{{ $annonce->id }}</td>
                                                <td>{{ $annonce->titre }}</td>
                                                <td>{{ Str::limit($annonce->text1, 100) }}</td>
                                                <td><img src="https://annuairestogo.com/assets/images/annonces/{{ $annonce->image1 }}"
                                                        width="60"></td>
                                                ...
                                                <td>
                                                    ...
                                                    <button class="btn btn-default"
                                                        onclick="deleteData({{ $annonce->id }})"
                                                        data-id="{{ $annonce->id }}"
                                                        data-target="#default{{ $annonce->id }}">
