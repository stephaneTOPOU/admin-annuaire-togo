            ...
            <div class="container-fluid">
                <div class="">
                    <div class="card card-primary">
                        ...
                        @endif
                        <form role="form" method="POST" action="{{ route('annonce.update', $annonces->id) }}"
                                            ...
                                            <select class="form-control select2" style="width: 100%;" name="categorie_id">
                                                ...
                                                @foreach ($categories as $categorie)
                                                    <option value="{{ $categorie->id }}"
                                                        @if ($categorie->id == $annonces->categorie_id) selected @endif>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Entrez le titre"
                                                name="titre" value="{{ old('titre') ?? $annonces->titre }}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"
                                                ...
                                                value="{{ old('descriptionCourte') ?? $annonces->descriptionCourte }}"
                                                required>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input"
                                                        ...
                                                        value="{{ old('image1') ?? $annonces->image1 }}">
                                                    <label class="custom-file-label"
                                                        for="exampleInputFile1">{{ old('image1') ?? $annonces->image1 }}</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input"
                                                        ...
                                                        value="{{ old('image2') ?? $annonces->image2 }}">
                                                    <label class="custom-file-label"
                                                        for="exampleInputFile2">{{ old('image2') ?? $annonces->image2 }}</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input"
                                                        ...
                                                        value="{{ old('image3') ?? $annonces->image3 }}">
                                                    <label class="custom-file-label"
                                                        for="exampleInputFile3">{{ old('image3') ?? $annonces->image3 }}</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input"
                                                        ...
                                                        value="{{ old('image4') ?? $annonces->image4 }}">
                                                    <label class="custom-file-label"
                                                        for="exampleInputFile4">{{ old('image4') ?? $annonces->image4 }}</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input"
                                                        ...
                                                        value="{{ old('image5') ?? $annonces->image5 }}">
                                                    <label class="custom-file-label"
                                                        for="exampleInputFile5">{{ old('image5') ?? $annonces->image5 }}</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input"
                                                        ...
                                                        value="{{ old('image6') ?? $annonces->image6 }}">
                                                    <label class="custom-file-label"
                                                        for="exampleInputFile6">{{ old('image6') ?? $annonces->image6 }}</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input"
                                                        ...
                                                        value="{{ old('video') ?? $annonces->video }}">
                                                    <label class="custom-file-label"
                                                        for="exampleInputFile7">{{ old('video') ?? $annonces->video }}</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
