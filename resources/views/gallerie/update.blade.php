            ...
            <div class="container-fluid">
                <div class="">
                    <div class="card card-primary">
                        ...
                        @endif
                        <form role="form" method="POST" action="{{ route('gallerie.update', $galleries->id) }}"
                                            ...
                                            <select class="form-control select2" style="width: 100%;"
                                                ...
                                                @foreach ($entreprises as $entreprise)
                                                    <option value="{{ $entreprise->id }}"
                                                        {{ $galleries->entreprise_id == $entreprise->id ? 'selected' : '' }}>
                                            ...
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input"
                                                        id="exampleInputFile" name="galerie_image"
                                                        value="{{ old('galerie_image') ?? $galleries->galerie_image }}">
                                                    <label class="custom-file-label"
                                                        for="exampleInputFile">{{ old('galerie_image') ?? $galleries->galerie_image }}</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
