            ...
            <div class="container-fluid">
                <div class="">
                    <div class="card card-primary">
                        ...
                        @endif
                        <form role="form" method="POST" action="{{ route('popup.update', $popups->id) }}"
                                            ...
                                            <select class="form-control select2" style="width: 100%;"
                                                ...
                                                @foreach ($entreprises as $entreprise)
                                                    <option value="{{ $entreprise->id }}"
                                                        @if ($entreprise->id == $popups->entreprise_id) selected @endif>
                                            ...
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input"
                                                        ...
                                                        value="{{ old('image') ?? $popups->image }}" multiple>
                                                    <label class="custom-file-label"
                                                        for="exampleInputFile">{{ old('image') ?? $popups->image }}</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
