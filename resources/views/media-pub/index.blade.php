                                    ...
                                    <tbody>
                                        @foreach ($medias as $media)
                                            <tr>
                                                ...
                                                @if ($media->imageSpot)
                                                    <td><img src="https://annuairestogo.com/assets/videos/posters/{{ $media->imageSpot }}"
                                                            width="60"></td>
                                                @endif

                                                @if ($media->videoSpot)
                                                    <td><video
                                                            src="https://annuairestogo.com/assets/videos/{{ $media->videoSpot }}"
                                                            width="200" height="100" autoplay muted
                                                            type="video/mp4"> </video></td>
                                                @endif

                                                @if ($media->youtube)
                                                    <td><iframe width="100%" height="100px"
                                                            src="{{ $media->youtube }}" title="YouTube video player"
                                                            frameborder="0"
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a href="{{ route('media-pub.edit', $media->identifiant) }}"
