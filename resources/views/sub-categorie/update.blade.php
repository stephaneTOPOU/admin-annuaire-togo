                ...
                <div class="">
                    <div class="card card-primary">
                        ...
                        <form role="form" method="POST"
                            action="{{ route('sub-category.update', $souscategories->id) }}">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                    ...
                                    <select class="form-control select2" style="width: 100%;" name="categorie_id">
                                        ...
                                        @foreach ($categories as $categorie)
                                            <option value="{{ $categorie->id }}"
                                                @if ($categorie->id == $souscategories->categorie_id) selected @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputEmail1"
                                        value="{{ old('libelle') ?? $souscategories->libelle }}"
                                        placeholder="Entrez le nom" name="libelle" required>
                                </div>
