                                    ...
                                    <tbody>
                                        @foreach ($sousCategories as $sousCategorie)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a href="{{ route('sub-category.edit', $sousCategorie->identifiant) }}"
                                                    ...
                                                    <button class="btn btn-default"
                                                        onclick="deleteData({{ $sousCategorie->identifiant }})"
                                                        data-id="{{ $sousCategorie->identifiant }}"
                                                        data-target="#default{{ $sousCategorie->identifiant }}">
                                                        <i class="fas fa-trash"></i> Supprimer
                                                    </button>
