                                    ...
                                    <tbody>
                                        @foreach ($slider1s as $slider1)
                                            <tr>
                                                ...
                                                <td>{{ $slider1->admin }}</td>
                                                <td><img src="https://annuairestogo.com/assets/images/sliders/{{ $slider1->image }}"
                                                        width="100"></td>
                                                <td>{{ $slider1->created_at }}</td>
                                                <td>
                                                    <div class="btn-group">
                                                        <a href="{{ route('slider1.edit', $slider1->identifiant) }}"
                                                    ...
                                                    <button class="btn btn-default"
                                                        onclick="deleteData({{ $slider1->identifiant }})"
                                                        data-id="{{ $slider1->identifiant }}"
                                                        data-target="#default{{ $slider1->identifiant }}">
                                                        <i class="fas fa-trash"></i> Supprimer
                                                    </button>
