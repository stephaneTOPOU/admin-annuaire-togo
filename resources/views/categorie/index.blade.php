                                    ...
                                    <tbody>
                                        @foreach ($categories as $categorie)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a href="{{ route('category.edit', $categorie->identifiant) }}"
                                                    ...
                                                    <button class="btn btn-default"
                                                        onclick="deleteData({{ $categorie->identifiant }})"
                                                        data-id="{{ $categorie->identifiant }}"
                                                        data-target="#default{{ $categorie->identifiant }}">
                                                        <i class="fas fa-trash"></i> Supprimer
                                                    </button>
