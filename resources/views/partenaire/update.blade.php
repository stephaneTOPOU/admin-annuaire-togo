            ...
            <div class="container-fluid">
                <div class="">
                    <div class="card card-primary">
                        ...
                        @endif
                        <form role="form" method="POST" action="{{ route('partenaire.update', $partenaires->id) }}"
                                            ...
                                            <select class="form-control select2" style="width: 100%;"
                                                ...
                                                @foreach ($entreprises as $entreprise)
                                                    <option value="{{ $entreprise->id }}"
                                                        {{ $partenaires->entreprise_id == $entreprise->id ? 'selected' : '' }}>
                                            ...
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input"
                                                        ...
                                                        value="{{ old('image') ?? $partenaires->image }}">
                                                    <label class="custom-file-label"
                                                        for="exampleInputFile">{{ old('image') ?? $partenaires->image }}</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
