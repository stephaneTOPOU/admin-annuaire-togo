                                    ...
                                    <tbody>
                                        @foreach ($partenaires as $partenaire)
                                            <tr>
                                                ...
                                                <td><img src="https://annuairestogo.com/assets/images/partenaires/{{ $partenaire->image }}"
                                                        width="60"></td>
                                                <td>{{ $partenaire->created_at }}</td>
                                                <td>
                                                    <div class="btn-group">
                                                        <a href="{{ route('partenaire.edit', $partenaire->identifiant) }}"
                                                    ...
                                                    <button class="btn btn-default"
                                                        onclick="deleteData({{ $partenaire->identifiant }})"
                                                        data-id="{{ $partenaire->identifiant }}"
                                                        data-target="#default{{ $partenaire->identifiant }}">
                                                        ...
                                                        function deleteData(identifiant) {
                                                            ...
                                                            Swal.fire({
                                                                ...
                                                                if (result.isConfirmed) {
                                                                    ...
                                                                    let url = "{{ url('partenaire') }}/" + identifiant
