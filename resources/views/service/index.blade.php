                                    ...
                                    <tbody>
                                        @foreach ($services as $service)
                                            <tr>
                                                ...
                                                <td><img src="https://annuairestogo.com/assets/images/entreprises/services/{{ $service->image2 }}"
                                                        width="60"></td>
                                                <td>{{ $service->image5 }}</td>
                                                <td><img src="https://annuairestogo.com/assets/images/entreprises/services/{{ $service->image3 }}"
                                                        width="60"></td>
                                                <td>{{ $service->created_at }}</td>
                                                <td>
                                                    <div class="btn-group">
                                                        <a href="{{ route('service.edit', $service->identifiant) }}"
                                                    ...
                                                    <button class="btn btn-default"
                                                        onclick="deleteData({{ $service->identifiant }})"
                                                        data-id="{{ $service->identifiant }}"
                                                        data-target="#default{{ $service->identifiant }}">
